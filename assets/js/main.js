...
import("../../src/modules/signal-motion").then(function (signalMotionModule) {
      ...
      var translations = {
        en: {
          ...
          signalProjectsNote: "Operations, private financial analysis, healthcare, solar energy and an agricultural catalog.",
          signalProjectsAction: "Go to selected projects",
          signalCoverageLabel: "Project coverage",
          signalCoverageAria: "Verified capabilities across five portfolio projects",
          ...
          projectsKicker: "Selected work / 05 builds",
          ...
          skillsIntro: "Capabilities demonstrated across five shipped projects, now covering product architecture, private on-device data, automated testing and production delivery.",
        ...
        pt: {
          ...
          signalProjectsNote: "Operações, análise financeira privada, saúde, energia solar e catálogo agrícola.",
          signalProjectsAction: "Ir para os projetos selecionados",
          signalCoverageLabel: "Cobertura dos projetos",
          signalCoverageAria: "Capacidades verificadas nos cinco projetos do portfólio",
          signalCoverageReact: "React",
          ...
          projectsKicker: "Projetos selecionados / 05 entregas",
          ...
          skillsIntro: "Competências demonstradas em cinco projetos publicados, agora incluindo arquitetura de produto, dados privados no dispositivo, testes automatizados e entrega em produção.",
