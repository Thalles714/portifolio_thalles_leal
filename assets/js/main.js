...
import("../../src/modules/signal-motion").then(function (signalMotionModule) {
      ...
      var translations = {
        en: {
          ...
          skillsIntro: "Capabilities demonstrated across four shipped projects, now covering product architecture, private on-device data, automated testing and production delivery.",
        ...
        pt: {
          ...
          skillsIntro: "Competências demonstradas em quatro projetos publicados, agora incluindo arquitetura de produto, dados privados no dispositivo, testes automatizados e entrega em produção.",
